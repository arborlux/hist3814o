            ...
            <body>
                <div id="page-wrap">
                    ...
                    <div id="card-paragraph">
                        <p>This project aims to transcribe the scanned images of the No.10 Canadian Stationary Hospital war diary during the Great War and make them as accessible and open-source as possible.</p>
                        <p>All files related to this project, including references, the scanned images, and further information can be found <a href="https://github.com/arborlux/hist3814o/tree/master/Final%20Project">here</a>.</p>
                        <p>The original scans are provided with Open access on the Library and Archives Canada Portal <a href="http://collectionscanada.gc.ca/pam_archives/index.php?fuseaction=genitem.displayItem&amp;lang=eng&amp;rec_nbr=2005110&amp;rec_nbr_list=3366167,3203123,2005097,2005100,2005101,2005099,2005096,2005110,2005108,2005106">here</a>.</p>
                    </div>
